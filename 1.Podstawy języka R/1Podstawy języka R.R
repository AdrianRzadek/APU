# a) Do zmiennej a podstaw wartość wyrażenia 12/exp(12).Do zmiennej b podstaw podwójną wartość zmiennej a.Wywołaj funkcję sprawdzającą, która z wartości zmiennych jest większa.
a <- 12 / exp(12)  
b <- 2 * a         
